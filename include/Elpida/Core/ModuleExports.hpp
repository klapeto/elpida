...
#define ELPIDA_CREATE_BENCHMARK_GROUP_FUNC ELPIDA_EXPORT Elpida::BenchmarkGroupPtr ELPIDA_STDCALL ELPIDA_CREATE_BENCHMARK_GROUP_NAME
...
#define ELPIDA_DESTROY_BENCHMARK_GROUP_FUNC ELPIDA_EXPORT void ELPIDA_STDCALL ELPIDA_DESTROY_BENCHMARK_GROUP_NAME
