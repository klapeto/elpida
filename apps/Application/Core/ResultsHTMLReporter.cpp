...
namespace Elpida::Application
{
			...
			const BenchmarkRunConfigurationModel& runConfigurationModel)
	{
		...
		stream << "<tr><td>Concurrency hint</td><td>" << GetConcurrencyModeStr(runConfigurationModel.GetConcurrencyMode()) << "</td></tr>";
		stream << "<tr><td><label for='numa-aware'>Numa aware</label></td><td><input id='numa-threads' type='checkbox' " << (runConfigurationModel.IsNumaAware() ? "checked": "") << "/></td></tr>";
		stream << "<tr><td><label for='pined-threads'>Pined threads</label></td><td><input id='pined-threads' type='checkbox' " << (runConfigurationModel.IsPinThreads() ? "checked": "") << "/></td></tr>";
	...
	static std::string GenerateStatistics(const std::vector<BenchmarkResultModel>& results, const BenchmarkStatisticsService& statisticsService)
	{
		...
		stream << "<tr><td>Sample size</td><td>" << ValueUtilities::GetValueScaleStringSI(statistics.sampleSize) << "</td></tr>";
		stream << "<tr><td>Mean</td><td>" << GetScoreValue(statistics.mean, scoreUnit) << "</td></tr>";
		stream << "<tr><td>Max</td><td>" << GetScoreValue(statistics.max, scoreUnit) << GetScoreDelta(statistics.max, statistics.mean) << "</td></tr>";
		stream << "<tr><td>Min</td><td>" << GetScoreValue(statistics.min, scoreUnit) << GetScoreDelta(statistics.min, statistics.mean) << "</td></tr>";
		stream << "<tr><td>Std Dev</td><td>" << GetScoreValue(statistics.standardDeviation, scoreUnit) << GetNormalDelta(statistics.standardDeviation, statistics.mean) << "</td></tr>";
		stream << "<tr><td>Margin of error</td><td>" << GetScoreValue(statistics.marginOfError, scoreUnit) << GetNormalDelta(statistics.marginOfError, statistics.mean) << "</td></tr>";
