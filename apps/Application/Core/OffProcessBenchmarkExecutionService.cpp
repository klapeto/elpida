...
#include "OffProcessBenchmarkExecutionService.hpp"
...
namespace Elpida::Application
{
	...
	OffProcessBenchmarkExecutionService::Execute(const BenchmarkModel& benchmarkModel,
	...
	void OffProcessBenchmarkExecutionService::StopCurrentExecution()
	{
		try
		{
