...
{
	Base64Encode::Base64Encode(const std::string& uuid,
			Score baseScore,
			bool multiThreaded,
			...
			:FullBenchmarkInstance("Base64 Encode", uuid, baseScore, multiThreaded, benchmark, timingModel,
			topologyModel,
			memoryInfoModel,
