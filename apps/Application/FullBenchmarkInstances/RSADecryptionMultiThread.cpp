...
#include "RSADecryptionMultiThread.hpp"
...
{
	const Score BaseScore = 198.37 * std::kilo::num;

	std::string RSADecryptionMultiThread::GetName() const
	{
		return "RSA Decryption (Multi Thread)";
	}

	std::string RSADecryptionMultiThread::GetUuid() const
	{
		return "bae420c9-3297-456c-bbc2-6b884af15bb7";
	}

	FullBenchmarkInstanceResult RSADecryptionMultiThread::Run()
	{
	...
	RSADecryptionMultiThread::RSADecryptionMultiThread(const BenchmarkModel& benchmark, const TimingModel& timingModel,
