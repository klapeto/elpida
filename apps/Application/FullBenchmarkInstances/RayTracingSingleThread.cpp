...
#include "RayTracingSingleThread.hpp"
...
{
	const Score BaseScore = 1.03 * std::mega::num;

	std::string RayTracingSingleThread::GetName() const
	{
		return "Ray Tracing (Single Thread)";
	}

	std::string RayTracingSingleThread::GetUuid() const
	{
		return "ad8da8ff-a1f3-4a21-9234-43b6aff8eea4";
	}

	FullBenchmarkInstanceResult RayTracingSingleThread::Run()
	{
	...
	RayTracingSingleThread::RayTracingSingleThread(const BenchmarkModel& benchmark, const TimingModel& timingModel,
