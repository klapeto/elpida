...
#ifndef ELPIDA_REGEX_HPP
#define ELPIDA_REGEX_HPP

#include "Controllers/FullBenchmarkInstance.hpp"

namespace Elpida::Application
{
	class Regex : public FullBenchmarkInstance
	{
	public:
		Regex(const std::string& uuid,
				Score baseScore,
				bool multiThreaded,
		...
		Regex& operator=(Regex&&) noexcept = delete;
