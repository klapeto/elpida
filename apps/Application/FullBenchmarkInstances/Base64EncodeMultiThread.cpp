...
#include "Base64EncodeMultiThread.hpp"
...
{
	const Score BaseScore = 297.56 * std::mega::num;

	std::string Base64EncodeMultiThread::GetName() const
	{
		return "Base64 Encode (Multi Thread)";
	}

	std::string Base64EncodeMultiThread::GetUuid() const
	{
		return "00a8b5a5-eb3e-45b5-bced-f90895103f7d";
	}

	FullBenchmarkInstanceResult Base64EncodeMultiThread::Run()
	{
	...
	Base64EncodeMultiThread::Base64EncodeMultiThread(const BenchmarkModel& benchmark, const TimingModel& timingModel,
