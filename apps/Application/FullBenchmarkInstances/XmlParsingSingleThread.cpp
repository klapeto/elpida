...
#include "XmlParsingSingleThread.hpp"
...
namespace Elpida::Application
{
	...
	std::string XmlParsingSingleThread::GetName() const
	{
		return "Xml Parsing (Single Thread)";
	}

	std::string XmlParsingSingleThread::GetUuid() const
	{
		return "70b7048f-face-4976-b68a-d8cd1004ad33";
	}

	FullBenchmarkInstanceResult XmlParsingSingleThread::Run()
	{
	...
	XmlParsingSingleThread::XmlParsingSingleThread(const BenchmarkModel& benchmark, const TimingModel& timingModel,
