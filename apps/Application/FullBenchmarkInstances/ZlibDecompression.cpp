...
#include "ZlibDecompression.hpp"
#include "Elpida/Platform/OsUtilities.hpp"
#include "Models/Benchmark/BenchmarkModel.hpp"

namespace Elpida::Application
{
	ZlibDecompression::ZlibDecompression(const std::string& uuid,
			Score baseScore,
			bool multiThreaded,
			...
			:FullBenchmarkInstance("Zlib Decompression", uuid, baseScore, multiThreaded, benchmark, timingModel,
			topologyModel,
			memoryInfoModel,
	...
	void ZlibDecompression::Configure()
	{
