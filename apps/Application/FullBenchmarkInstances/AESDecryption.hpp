...
#ifndef ELPIDA_AESDECRYPTION_HPP
#define ELPIDA_AESDECRYPTION_HPP
...
namespace Elpida::Application
{
	...
	class AESDecryption : public FullBenchmarkInstance
	{
	public:
		AESDecryption(const std::string& uuid,
				Score baseScore,
				bool multiThreaded,
		...
		AESDecryption(AESDecryption&&) noexcept = default;
		AESDecryption& operator=(const AESDecryption&) = delete;
		AESDecryption& operator=(AESDecryption&&) noexcept = delete;
...
#endif //ELPIDA_AESDECRYPTION_HPP
