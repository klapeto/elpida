...
#include "MatrixInverseSingleThread.hpp"
...
{
	const Score BaseScore = 48.98 * std::mega::num;

	std::string MatrixInverseSingleThread::GetName() const
	{
		return "Matrix Inverse (Single Thread)";
	}

	std::string MatrixInverseSingleThread::GetUuid() const
	{
		return "7930adf1-fd99-420a-9a39-b4e147f1bdf2";
	}

	FullBenchmarkInstanceResult MatrixInverseSingleThread::Run()
	{
	...
	MatrixInverseSingleThread::MatrixInverseSingleThread(const BenchmarkModel& benchmark,
