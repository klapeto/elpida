...
{
	SvgRasterization::SvgRasterization(const std::string& uuid,
			Score baseScore,
			bool multiThreaded,
			...
			:FullBenchmarkInstance("SVG Rasterization", uuid, baseScore, multiThreaded, benchmark, timingModel,
			topologyModel,
			memoryInfoModel,
	...
	void SvgRasterization::Configure()
	{
