...
#include "Base64DecodeSingleThread.hpp"
...
{
	const Score BaseScore = 28.94 * std::mega::num;

	std::string Base64DecodeSingleThread::GetName() const
	{
		return "Base64 Decode (Single Thread)";
	}

	std::string Base64DecodeSingleThread::GetUuid() const
	{
		return "0a48078b-b924-43a9-97d9-6a9fcb2ebb45";
	}

	FullBenchmarkInstanceResult Base64DecodeSingleThread::Run()
	{
	...
	Base64DecodeSingleThread::Base64DecodeSingleThread(const BenchmarkModel& benchmark, const TimingModel& timingModel,
