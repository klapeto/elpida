...
{
	RSAEncryption::RSAEncryption(const std::string& uuid,
			Score baseScore,
			bool multiThreaded,
			...
			:FullBenchmarkInstance("RSA Encryption", uuid, baseScore, multiThreaded, benchmark, timingModel,
			topologyModel,
			memoryInfoModel,
