...
{
	const Score BaseScore = 16.74 * std::mega::num;

	std::string RegexSingleThread::GetName() const
	{
		return "Regex (Single Thread)";
	}

	std::string RegexSingleThread::GetUuid() const
	{
		return "bd0d8849-b988-40ac-9961-5e3528327da3";
	}

	FullBenchmarkInstanceResult RegexSingleThread::Run()
	{
	...
	RegexSingleThread::RegexSingleThread(const BenchmarkModel& benchmark, const TimingModel& timingModel,
