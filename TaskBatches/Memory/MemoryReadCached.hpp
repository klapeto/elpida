...
#ifndef TASKBATCHES_MEMORY_MEMORYREADCACHED_HPP_
#define TASKBATCHES_MEMORY_MEMORYREADCACHED_HPP_
...
namespace Elpida
{
	class MemoryReadCached: public Task
	{
		public:
			...
			MemoryReadCached(const Memory& memory, std::chrono::milliseconds duration)
					:
...
#endif /* TASKBATCHES_MEMORY_MEMORYREADCACHED_HPP_ */
