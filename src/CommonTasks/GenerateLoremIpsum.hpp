...
#ifndef ELPIDA_GENERATELOREMIPSUM_HPP
#define ELPIDA_GENERATELOREMIPSUM_HPP
...
namespace Elpida
{
	...
	class GenerateLoremIpsum: public Task
	{
	public:
		...
		explicit GenerateLoremIpsum(std::size_t size);
		~GenerateLoremIpsum() override = default;
	protected:
		void DoRun() override;
...
#endif //ELPIDA_GENERATELOREMIPSUM_HPP
