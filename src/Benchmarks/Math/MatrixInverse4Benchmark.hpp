...
#ifndef ELPIDA_MATRIXINVERSE4BENCHMARK_HPP
#define ELPIDA_MATRIXINVERSE4BENCHMARK_HPP
...
namespace Elpida
{
	...
	class MatrixInverse4Benchmark : public Benchmark
	{
	public:
		[[nodiscard]]
		Vector<TaskConfiguration> GetRequiredConfiguration() const override;

		MatrixInverse4Benchmark() = default;
		~MatrixInverse4Benchmark() override = default;
	protected:
		[[nodiscard]]
...
#endif //ELPIDA_MATRIXINVERSE4BENCHMARK_HPP
