...
#ifndef ELPIDA_BASE64DECODEBENCHMARK_HPP
#define ELPIDA_BASE64DECODEBENCHMARK_HPP
...
namespace Elpida
{
	...
	class Base64DecodeBenchmark : public Benchmark
	{
	public:
		[[nodiscard]]
		Vector<TaskConfiguration> GetRequiredConfiguration() const override;

		Base64DecodeBenchmark() = default;
		~Base64DecodeBenchmark() override = default;
	protected:
		[[nodiscard]]
...
#endif //ELPIDA_BASE64DECODEBENCHMARK_HPP
