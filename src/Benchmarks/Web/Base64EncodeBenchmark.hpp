...
#ifndef ELPIDA_BASE64ENCODEBENCHMARK_HPP
#define ELPIDA_BASE64ENCODEBENCHMARK_HPP
...
namespace Elpida
{
	...
	public:
		...
		Base64EncodeBenchmark() = default;
		~Base64EncodeBenchmark() override = default;
	protected:
		[[nodiscard]]
...
#endif //ELPIDA_BASE64ENCODEBENCHMARK_HPP
