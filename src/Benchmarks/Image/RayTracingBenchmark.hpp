...
#ifndef ELPIDA_RAYTRACINGBENCHMARK_HPP
#define ELPIDA_RAYTRACINGBENCHMARK_HPP
...
namespace Elpida
{
	...
	public:
		...
		RayTracingBenchmark() = default;
		~RayTracingBenchmark() override = default;
	protected:
		[[nodiscard]]
...
#endif //ELPIDA_RAYTRACINGBENCHMARK_HPP
